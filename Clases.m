...
idx = ismember(T(:,{'nombre','apellido'}),{'nombre_buscado','apellido_buscado'});
filas = find(idx);
% Nueva tabla 
nueva_tabla = table(T(filas,:))
% Agregar nueva info
nueva_tabla = addvars(nueva_tabla, nueva_informacion, 'After', 'apellido')
